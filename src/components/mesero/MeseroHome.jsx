...
function MeseroHome() {
    ...
    useEffect(() => {
        async function getPedidos() {
            try {
                const response = await axios.get("http://restaurante-front-git-main-davidmartinez0s-projects.vercel.app//v1/signos/verpedidos");
    ...
    useEffect(() => {
        async function getUsuarios() {
            try {
                const response = await axios.get("http://restaurante-front-git-main-davidmartinez0s-projects.vercel.app//v1/signos/verusuarios");
    ...
    async function handleRegister(e) {
        ...
        try {
            await axios.post("http://restaurante-front-git-main-davidmartinez0s-projects.vercel.app//v1/signos/pedidos", {
