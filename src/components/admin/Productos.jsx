...
function RegistroHome() {
    ...
    useEffect(() => {
        async function getUsuarios() {
            try {
                const response = await axios.get("https://restaurante-back-eight.vercel.app/v1/signos/consulproduc");
    ...
    async function handleRegister(e) {
        ...
        try {
            const response = await axios.post("https://restaurante-back-eight.vercel.app/v1/signos/crearproduc", {
                nombreproduc, precio
            });
